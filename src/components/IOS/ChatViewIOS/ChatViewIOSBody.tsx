...
const ChatViewIOSBody:FC<AppProps> = ({height,width,}):JSX.Element => {
    ...
    return (
        <GestureHandlerRootView style={{flex:1,}}>
            <FlatList ref={flatlistRef} data={data} inverted={true} renderItem={renderItem} keyExtractor={keyExtractor}  />
            ...
            <View style={{backgroundColor:colors.zLgray,height:height*0.055,width:width*0.96,alignSelf:'center',borderRadius:height*0.04,flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginBottom:height*0.01}}>
                ...
                <TextInput ref={inputRef} onChangeText={(e)=>dispatch(txtMsgController(e))} value={textMsg} placeholderTextColor={colors.placeholderColor} placeholder='Type your message here..' style={{height:height*0.05,width:width*0.7,color:'white',fontSize:height*0.018}}/>
